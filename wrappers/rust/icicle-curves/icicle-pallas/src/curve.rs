...
use ark_pallas::{Fq, Fr, PallasConfig as ArkG1Config};
...
impl_scalar_field!("pallas", pallas_sf, SCALAR_LIMBS, ScalarField, ScalarCfg, Fr);
...
#[cfg(test)]
mod tests {
    use crate::curve::{pallas, G1Affine};
