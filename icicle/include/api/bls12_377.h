...
extern "C" cudaError_t bls12_377_mul_mat_cuda(
  bls12_377::scalar_t* vec_a, bls12_377::scalar_t* mat, int* row_ptr, int* col_idx, int n_rows, int n_cols, vec_ops::VecOpsConfig& config, bls12_377::scalar_t* result);

extern "C" cudaError_t bls12_377_prepare_matrix_cuda(
  bls12_377::scalar_t* mat,
  int* row_ptr,
  int* col_idx,
  ...
  int num_dense_rows,
  device_context::DeviceContext& ctx,
  HybridMatrix<bls12_377::scalar_t>* output);

extern "C" cudaError_t bls12_377_compute_t_cuda(
  HybridMatrix<bls12_377::scalar_t>* a,
  HybridMatrix<bls12_377::scalar_t>* b,
  HybridMatrix<bls12_377::scalar_t>* c,
  bls12_377::scalar_t* z1_u,
  bls12_377::scalar_t* z1_x,
  bls12_377::scalar_t* z1_qw,
  bls12_377::scalar_t* z2_u,
  bls12_377::scalar_t* z2_x,
  bls12_377::scalar_t* z2_qw,
  bls12_377::scalar_t* e,
  int n_pub,
  int n_rows,
  int n_cols,
  device_context::DeviceContext& ctx,
...
extern "C" cudaError_t bls12_377_update_e_cuda(
  bls12_377::scalar_t* e,
  bls12_377::scalar_t* t,
  bls12_377::scalar_t* r,
  int n,
  device_context::DeviceContext& ctx);

extern "C" cudaError_t bls12_377_return_e_cuda(
  bls12_377::scalar_t* d_e,
  int n,
  device_context::DeviceContext& ctx,
  bls12_377::scalar_t* h_e);
